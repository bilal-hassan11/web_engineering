...
<head>
    ...
    <title>Bilal Feed | Outward Details</title>
                          ...
                          <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="breadcomb-ctn">
                                      <h1 style="color: white;">All Outward</h1>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="header-title" style="color: white;">Outward Details</h4>
                            </div>
                            <p class="sub-header" style="color: white;">Following is the list of all the Outwards detail.</p>
                            ...
                            <thead style="border-color: white;">
                                    <tr >
                                        ...
                                        <th style="color: white;"> Bilty No </th>
                                        ...
                                        <th style="color: white;"> Driver Name </th>
                                        <th style="color: white;"> Driver Mob No </th>
                                ...
                                <tbody>
                                    ...
                                    <td style="color: white;">{{ $inw->bilty_no }}</td>
                                    ...
                                    <td style="color: white;">{{ $inw->driver_name }}</td>
                                    <td style="color: white;">{{ $inw->driver_phone_no }}</td>
