<ul class="list-unstyled topnav-menu float-end mb-0">
    ...
    <li class="dropdown notification-list topbar-dropdown d-none">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-lg">
            ...
            <div class="noti-scroll" data-simplebar>
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <div class="notify-icon">
                        <img src="{{asset('admin_assets')}}/images/users/user-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
    ...
    <li class="dropdown notification-list topbar-dropdown">
        <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
            ...
            <span class="pro-user-name ms-1">
                <span class="pro-user-name ml-1"> {{ auth('admin')->user()->name }} </span> <i class="mdi mdi-chevron-down"></i> 
            </span>
        </a>
 ...
 <div class="logo-box">
    {{-- <a href="{{ route('admin.home') }}" class="logo logo-light text-center">
        <span class="logo-sm">
            <img src="{{asset('admin_assets')}}/images/web_logo_sm.png" alt="" height="55">
        </span>
        <span class="logo-lg">
            <img src="{{asset('admin_assets')}}/images/web_logo.png" alt="" height="55">
        </span>
    </a> --}}
</div>
